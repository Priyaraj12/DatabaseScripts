...
(function () {
  ...
  angular.module('coApplicantFinancialService', [])
    .service('getCoApplicantFinancialService', function ($http,getcokkies,config,api) {
	  ...
	  this.getorganizationlistusingemployernameandcategory = function(data){
  	      return $http.post(api.coApplicantFinancial.getorganizationlistusingemployernameandcategory+getcokkies.getsessionId(),data);
  	  };
	  //Added by Priyaraj on 23-02-2023 to get organizationlist using employer name and employer category
