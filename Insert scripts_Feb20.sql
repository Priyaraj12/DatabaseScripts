...
CREATE TABLE `staging`.`getmyLpi_All_Lenders_consolelogs` (
  ...
  insert into getmyLpi_All_Lenders_consolelogs select concat('in begin before updating active status',activeStatus);
 select * from getmyLpi_All_Lenders_consolelogs;
