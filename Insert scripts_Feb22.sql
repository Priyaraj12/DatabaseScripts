...
select startrange,endrange,loantypeid,productTypeId,OccupationTypeId,ITfiled,minRate,maxRate from ref_interest_rates where lenderid = 0 and loantypeid = 1;
